...
from models.gen_3d_scene.world_mirror_utils.src.models.utils.grid import (
    create_uv_grid,
...
class DPTHead(nn.Module):
    ...
    # This module implements the DPT (Dense Prediction Transformer) head as proposed in # "Vision
    ...
    def activate_head(
        ...
        """Process network output to extract attribute (e.g. points, depth, etc.) and confidence
        values.
    ...
    def _apply_inverse_log_transform(
